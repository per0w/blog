      ...
      <article className="prose max-w-none prose-neutral dark:prose-invert">
        ...
        <div className="not-prose my-6 rounded-xl border border-border bg-surface p-4 text-sm leading-relaxed text-muted shadow-elevation-panel">
          ...
          <p className="mt-2 text-xs text-muted">
            ...
            менторства; текст ниже адаптирован под индивидуальное оказание услуг Владимиром Перовым,
            а не скопирован.
          </p>
        </div>
        ...
        <p className="text-sm leading-relaxed text-muted">
          ...
          использования (включая решения о трудоустройстве, выборе стека, сделках с третьими лицами,
        ...
        <p className="text-sm leading-relaxed text-muted">
          7.1. Совершая акцепт, Заказчик даёт согласие на обработку своих персональных данных (ФИО,
        ...
        <p className="text-sm leading-relaxed text-muted">
          ...
          ; в таком случае Исполнитель возвращает оплату за вычетом стоимости фактически оказанных
          услуг и документально подтверждённых расходов.
        </p>
        <p className="text-sm leading-relaxed text-muted">
        ...
        <p className="text-sm leading-relaxed text-muted">
          9.4. Удержание комиссий банка или платёжной системы может производиться в соответствии с
          их правилами. При отсутствии отдельной договорённости спорные вопросы возврата разрешаются
          с учётом фактического исполнения и принципа добросовестности.
        </p>
