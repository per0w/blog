...
import { ArrowRight, Gauge, Globe, Layers, Server, Sparkles, Wrench } from "lucide-react";
      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-8 px-4">
        <div className="text-center md:text-left">
          <p className="text-lg leading-relaxed text-muted">
            ...
            <strong className="font-semibold text-foreground">любой сложности</strong>: от
            лаконичной визитки в сети до полноценного веб-приложения и настройки инфраструктуры.
            Один контакт — и вы получаете инженера с опытом лида и DevOps: без лишних посредников и
            в лучших традициях — прозрачные сроки, аккуратный код и честное «да/нет» по срокам и
            рискам.
          </p>
          <p className="mt-4 flex flex-wrap items-center justify-center gap-2 text-sm text-muted md:justify-start">
            ...
            <span>
              Формат и бюджет обсуждаем до старта: фиксированная оплата, оплата по этапам или
              почасовая оплата — как удобнее под вашу задачу. Условия работы закреплены в{" "}
              <Link
        ...
        <div className="flex flex-col items-stretch gap-5 rounded-2xl border border-accent/25 bg-[color-mix(in_srgb,var(--color-accent)_8%,var(--color-surface))] px-5 py-6 text-center md:flex-row md:items-center md:justify-between md:text-left">
          <div className="flex max-w-xl flex-col gap-2">
            ...
            <p className="text-sm leading-relaxed text-muted">
              Удобнее всего написать в Telegram: приложите ссылку на прототип, макет или текущий
              сайт — так быстрее сойдёмся в понимании объёма.
            </p>
          </div>
