...
export function ImpactProjectCard({ emoji, title, problem, stack, role }: ImpactProjectCardProps) {
  ...
  return (
    <article
      className="flex h-full min-h-0 flex-col rounded-2xl border border-border bg-surface p-5 text-left shadow-sm transition-[box-shadow,border-color] duration-300 hover:border-accent/35 hover:shadow-md"
