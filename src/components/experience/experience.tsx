...
const ExperienceItem = ({ description, year, title }: ExperienceItemProps) => {
  return (
...
const DEFAULT_JOBS: ExperienceItemProps[] = [
  { year: "2016", description: "", title: "Optimax Dev - DevOps-инженер" },
  { year: "2018", description: "", title: "CosySoft - Frontend-разработчик" },
  {
    year: "2019",
    description: "",
    title: "Optimax Dev - Frontend-разработчик",
  },
  { year: "2020", description: "", title: "Optimax Dev - Frontend Team Lead" },
  {
    year: "2020",
    description: "",
